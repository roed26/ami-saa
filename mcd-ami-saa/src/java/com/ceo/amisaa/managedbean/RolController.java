...
import com.ceo.amisaa.sessionbeans.RolFacade;
...
public class RolController implements Serializable {
    ...
    @EJB
    private com.ceo.amisaa.sessionbeans.RolFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleRolUsuario").getString("RolCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleRolUsuario").getString("RolUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleRolUsuario").getString("RolDeleted"));
        if (!JsfUtil.isValidationFailed()) {
